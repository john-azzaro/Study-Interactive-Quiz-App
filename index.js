...
function generateFinalMessage(score) {
  ...
  switch (score) {
    case 0:
      message =
        "Deeds will not be less valient because they are unpraised. - J.R.R. Tolkein";
      break;
    case 1:
    ...
    default:
      message =
        "For victory is victory, however small, nor is its worth only from what follows from it. - J.R.R. Tolkein";
      break;
  }
  return message;
}
